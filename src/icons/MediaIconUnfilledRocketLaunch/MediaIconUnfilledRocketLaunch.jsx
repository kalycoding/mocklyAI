...
export const MediaIconUnfilledRocketLaunch = ({ className }) => {
  return (
    <svg
      className={`media-icon-unfilled-rocket-launch ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
